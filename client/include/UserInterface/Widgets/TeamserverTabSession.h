...
using namespace Phantom-OperatorNamespace;

class Phantom-OperatorNamespace::UserInterface::Widgets::TeamserverTabSession : public QWidget
{
    typedef struct
    {
...
public:
    ...
    Phantom-OperatorSpace::DBManager*            dbManager           = {};
